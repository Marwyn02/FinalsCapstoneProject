    ...
    <>
      <ParallaxProvider>
        <ParallaxBanner
          ...
          className="w-full h-[550px] md:h-[700px] object-cover brightness-75 contrast-125"
        >
          <div className="absolute w-full h-full px-5 md:px-28 inset-0 flex items-center justify-center md:justify-start text-white bg-black/20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 md:gap-x-5 md:mx-28 py-16 md:py-8 text-center md:text-start items-center space-y-14 md:space-y-2">
            ...
            <div className="grid gap-y-6 md:pr-6 text-base md:text-lg">
              <p>
                ...
                <a
                  ...
                  target="_blank"
                  className="text-[#c3923c] hover:underline"
                >
        ...
        <section className="space-y-2 hidden md:block">
          ...
          />
          <p className="font-bold text-sm text-[#c3923c] tracking-wider px-1">
