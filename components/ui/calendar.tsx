...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex justify-center sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4 w-full",
        month_caption: "flex justify-center mb-6 relative items-center",
        caption_label: "text-sm font-light uppercase tracking-wider",
        nav: "space-x-1",
        button_previous: "absolute left-16",
        button_next: "absolute right-16",
